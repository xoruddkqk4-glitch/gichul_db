...
2. **답변 또는 계획서 작성까지만 수행 (Answer or Plan Only)**:
   ...
   - 기술적 구현/복잡한 코드 변경 작업 요청인 경우 `implementation_plan.md` 작성까지만 진행합니다.
...
2. **응답 구분**:
   ...
   - **복잡한 작업/구현 요청**: `implementation_plan.md`에 분석 결과와 구현 계획을 작성합니다.
3. **완료 및 사용자 승인 대기**: 답변 또는 계획서 경로를 사용자에게 제공하고, 사용자의 명시적인 추가 실행 요청 전까지 작업을 정지하고 대기합니다.
